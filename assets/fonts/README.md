...
Both files are unmodified and licensed under the SIL Open Font License 1.1.
The complete license texts are included as `OFL-SairaCondensed.txt` and
`OFL-IBMPlexMono.txt` in this directory.
